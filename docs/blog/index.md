...
![@sdiricco][@sdiricco avatar]

<span>__Simone Di Ricco__ · @sdiricco</span>
<span>
...
requested by many users.
  ...
  [:octicons-arrow-right-24: Continue reading][Android bootloop fix]

  [built-in search plugin]: ../setup/setting-up-site-search.md#built-in-search-plugin
  [@sdiricco avatar]: ../assets/images/mypic.jpg
  [insiders-4.14.0]: ../insiders/changelog.md#4.14.0
  [lunr-languages]: https://github.com/MihaiValentin/lunr-languages
  [Android bootloop fix]: android/README.md
...
<span>__Martin Donath__ · @sdiricco</span>
<span>
